      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="p-4 border-b border-[#202938] flex justify-between items-center bg-[#090C10] shrink-0">
            ...
            <button
              onClick={() => setMobileOpen(false)}
              className="p-1.5 rounded-xl bg-[#11161F] hover:bg-[#18202C] text-gray-400 hover:text-white border border-[#202938] neu-raised transition md:hidden"
            ...
            <button
              ...
              className="hidden md:flex p-1.5 rounded-xl bg-[#11161F] hover:bg-[#18202C] text-gray-400 hover:text-white border border-[#202938] neu-raised transition focus-visible:ring-2 focus-visible:ring-[#FF5500]"
          ...
          {/* Categorized Sleek Navigation List */}
